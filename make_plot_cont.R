...
#              standard errors of the summary statistics for continuous response
#
# Input: fitted models objects from make_fits_cont.R and its corresponding
#        tibble from md_list in the wrangle_data output
#
# Output: plot and data used to generate the plot

# produce plot
make_plot_cont <- function(fits, data) {
